...
public enum Lang {
	...
	CMD_HELP_ADMIN_SET_PRIORITY("cmd.help_admin_setpriority", "&f&oChange the priority for a tag"),
	...
	CMD_ADMIN_SET_PRIORITY_INCORRECT("cmd.admin_set_priority_incorrect_usage", "&cIncorrect usage! &7/tags setpriority <identifier> <priority>"),
	CMD_ADMIN_SET_PRIORITY_SUCCESS("cmd.admin_set_priority_success", "&aPriority &f{0}&a set for &7: &f{1}"),
	CMD_ADMIN_SET_PRIORITY_FAIL("cmd.admin_set_priority_fail", "&f{0} &cis not a loaded tag name!"),
	CMD_ADMIN_SET_PRIORITY_NOT_A_NUMBER("cmd.admin_set_priority_not_a_number", "&f{0} &cis not a valid priority! It should be a number."),
	CMD_ADMIN_SET_PRIORITY_ALREADY_EXISTS("cmd.admin_set_priority_already_exists", "&cPriority &f{0}&c is already in use."),
