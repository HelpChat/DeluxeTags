...
import me.clip.deluxetags.listeners.QuitListener;
...
public class DeluxeTags extends JavaPlugin {
	...
	public void onEnable() {
		...
		getLogger().info("Scheduler mode: " + (Scheduler.isFolia() ? "Folia" : "Bukkit"));
	...
	public synchronized String getSavedTagIdentifier(String uuid) {
	...
	public synchronized void saveTagIdentifier(String uuid, String tagIdentifier) {
		FileConfiguration c = playerFile.getConfig();
		c.set(uuid, tagIdentifier);
		playerFile.saveConfig();
	}
	
	public synchronized void removeSavedTag(String uuid) {
		FileConfiguration c = playerFile.getConfig();
		if (c.contains(uuid)) {
			c.set(uuid, null);
			playerFile.saveConfig();
	...
	public synchronized void removeSavedTags(List<UUID> uuids) {
