...
public class DeluxeTags extends JavaPlugin {
	...
	private ScheduledTask cleanupTask = null;
	...
	public void onEnable() {
		...
		cleanupTask = getServer().getAsyncScheduler().runAtFixedRate(this, task -> new CleanupTask(this).run(), 300, 300, TimeUnit.SECONDS);
