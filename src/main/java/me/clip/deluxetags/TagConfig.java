...
public class TagConfig {
	...
	public int loadTags() {
		...
		if (c.contains("me/clip/deluxetags")) {
			
			Set<String> keys = c.getConfigurationSection("me/clip/deluxetags").getKeys(false);
	...
	public void saveTag(int priority, String identifier, String tag, String description) {
		FileConfiguration c = plugin.getConfig();
		c.set("deluxetags."+identifier+".order", priority);
